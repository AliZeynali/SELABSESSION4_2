...
public class Course implements Model {
    ...
    public void setStudents(String studentNumber){
        this.students = studentNumber;

    }
    public void addStudents(String studentNumber){
        this.students = this.students.concat(studentNumber.concat(","));
    }
